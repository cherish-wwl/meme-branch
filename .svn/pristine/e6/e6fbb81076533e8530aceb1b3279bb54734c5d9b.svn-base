		...
		<div class="panel-body">
			...
			<input type="hidden" name="id" id="id" value="${object.id}"/>
				<div class="form-group">
					<label class="col-xs-3 control-label">栏目分类:</label>
					<div class="col-xs-9">
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:20px;">上级栏目分类:</label>
					<div class="col-xs-9" style="padding-top:10px;">
						...
						$.ajax({
							...
							success:function(data){
								if(data){
									var options=createTreeSelect(data,'catname','id','顶级栏目分类');
									$('#pid').append(options);
									$('#pid').val('${object.pid}');
								}
							},
						...
						$('#pid').change(function(){
							...
							if(pid){
								$.ajax({
									url: '<%=basePath%>im/column/category/getCatColumn.do',
									type:'post',
									dataType:'json',
									data: {'id':pid},
									success:function(data){
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:20px;">所属栏目:</label>
					<div class="col-xs-9" style="padding-top:10px;">
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:20px;">图标:</label>
					<div class="col-xs-9" style="padding-top:10px;">
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:20px;">外链地址:</label>
					<div class="col-xs-9" style="padding-top:10px;">
						<input id="url" name="url" type="text" value="${object.url}" class="form-control">
						<p class="help-block">如需另外配置分类的外链访问地址，在此填写</p>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:20px;">描述:</label>
					<div class="col-xs-9" style="padding-top:10px;">
...
<script type="text/javascript" src="<%=basePath%>im/column/category/loadValidateRules.do"></script>
