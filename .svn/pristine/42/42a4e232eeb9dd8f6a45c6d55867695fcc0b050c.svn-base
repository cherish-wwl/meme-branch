...
public class MemeCommunityController extends BaseController{
	@Resource 
	...
	public ModelAndView home(String columnid) {
		...
		return new ModelAndView("/im/community/home", model);
	}
	...
	public ModelAndView editView(Long id,Long columnid) throws Exception{
		...
		return new ModelAndView("/im/community/edit",resultMap);
	}
	...
	@ResponseBody
	@SysLog(event = "删除社区主页内容",type=LogType.DELETE)
	@Transactional
