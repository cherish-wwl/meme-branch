 ...
 *
 */
public class ExpressSqlSessionTemplate extends SqlSessionTemplate {
	...
	public ExpressSqlSessionTemplate(SqlSessionFactory sqlSessionFactory) {
	...
	public SqlSessionFactory getSqlSessionFactory() {
		...
		SqlSessionFactory targetSqlSessionFactory = targetSqlSessionFactorys
				.get(ExpressContextHolder.getContextType());
	...
	private class SqlSessionInterceptor implements InvocationHandler {
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			final SqlSession sqlSession = SqlSessionUtils.getSqlSession(
					ExpressSqlSessionTemplate.this.getSqlSessionFactory(),
					ExpressSqlSessionTemplate.this.executorType,
					ExpressSqlSessionTemplate.this.exceptionTranslator);
			try {
				...
				if (ExpressSqlSessionTemplate.this.exceptionTranslator != null
						&& unwrapped instanceof PersistenceException) {
					Throwable translated = ExpressSqlSessionTemplate.this.exceptionTranslator
