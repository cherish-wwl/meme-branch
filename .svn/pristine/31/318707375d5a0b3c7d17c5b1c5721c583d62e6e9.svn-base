	    ...
	    <form enctype="multipart/form-data" id="form">
			...
			<div id="uploader" data-role="none">
			        ...
			        <div id="dndArea" class="placeholder" data-role="none">
			            <div id="filePicker" class="webuploader-container">
				            ...
				            <div data-role="none" style="position: absolute; top: 0px; left: 66.6px; width: 168px; height: 44px; overflow: hidden; bottom: auto; right: auto;">
				            	<input data-role="none" type="file" name="file" class="webuploader-element-invisible" multiple="multiple" accept="image/*">
				            	<label data-role="none" style="opacity: 0; width: 100%; height: 100%; display: block; cursor: pointer; background: rgb(255, 255, 255);"></label>
				            </div>
			            </div>
			            <p data-role="none">单次最多可选15张</p>
			        </div>
			    ...
			    <div class="statusBar" style="display:none;" data-role="none">
			        ...
			        </div><div class="info" data-role="none">共0张（0B），已上传0张</div>
			...
			<div class="ui-input-btn ui-btn ui-corner-all ui-shadow">
		    	<input type="button" data-inline="true" id="updateAvatar" value="更新相册">
			</div>
	    	--%>
	    </form>
	</div>
...
$(document).ready(function(){
	<%--$('#updateAvatar').on('tap',function(){
		...
		$.ajax({
            url: '<%=basePath%>member/center/doUpdateAlbum',
            type: 'POST',
			cache: false,
			contentType: false,
			processData: false,
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        chunked: true,
        server: '<%=basePath%>member/center/doUpdateAlbum',
        fileNumLimit: 15,
