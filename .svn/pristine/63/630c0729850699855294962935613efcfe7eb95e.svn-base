...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <form enctype="multipart/form-data" id="uploadForm">
      ...
      <%--<label for="cmpassword">确认密码：</label>
      <input type="password" name="cmpassword" id="cmpassword" value="">
      
      --%><label for="nickname">昵称：</label>
      <input type="text" name="nickname" id="nickname" value="">
      <label for="sign">个性签名：</label>
      <input type="text" name="sign" id="sign" value="" placeholder="请输入个性签名">
      ...
      <label for="domain">域名：<span style="color:blue;font-weight:bold;"></span></label>
