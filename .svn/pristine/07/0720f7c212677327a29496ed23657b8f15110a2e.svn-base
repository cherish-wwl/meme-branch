...
@Controller
@RequestMapping("/im/music/")
public class MemeMusicController extends BaseController{
	@Resource 
	...
	public ModelAndView home(String columnid) {
		...
		return new ModelAndView("/im/music/home", model);
	}
	...
	public ModelAndView editView(Long id,Long columnid) throws Exception{
		...
		return new ModelAndView("/im/music/edit",resultMap);
	}
	...
	@ResponseBody
	@SysLog(event = "删除音乐或MV",type=LogType.DELETE)
	@Transactional
	...
	public ModelAndView index(@RequestParam("type")String type,@RequestParam("columnid")String columnid) {
		...
		model.put("columnid", columnid);
		return new ModelAndView("/im/music/list", model);
	}
	
	@RequestMapping("mvIndex")
	public ModelAndView mvindex(@RequestParam("type")String type,@RequestParam("columnid")String columnid) {
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("movieType", type);
		model.put("columnid", columnid);
		return new ModelAndView("/im/music/mvlist", model);
	}
	...
	@ResponseBody
	@SysLog(event = "添加音乐或MV",type=LogType.ADD)
	...
	@ResponseBody
	@SysLog(event = "编辑音乐或MV",type=LogType.ADD)
