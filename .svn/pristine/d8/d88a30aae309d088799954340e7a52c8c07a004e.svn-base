...
@Controller
@RequestMapping("/im/tv/")
public class MemeTvController extends BaseController{
	@Resource 
	...
	public ModelAndView home(String columnid) {
		...
		return new ModelAndView("/im/tv/home", model);
	}
	...
	public ModelAndView editView(Long id,Long columnid) throws Exception{
		...
		return new ModelAndView("/im/tv/edit",resultMap);
	}
	...
	@ResponseBody
	@SysLog(event = "删除电视",type=LogType.DELETE)
	@Transactional
