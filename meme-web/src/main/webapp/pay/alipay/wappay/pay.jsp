...
<div id="main">
        <form name='alipayment' action='<%=basePath%>pay/alipay/wap/pay.do' method=post target="_blank">
                ...
                <dl class="content">
                    ...
                    <dd id="btn-dd">
                        <span class="new-btn-login-sp">
                            <button class="new-btn-login" id="payBtn" type="submit" style="text-align:center;">确 认</button>
                        </span>
