...
<table id="grid" toolbar="#toolbar">
	<thead>
		<tr>
			...
			<th field="cover" sortable="true" align="center" width="13%">图片</th>
			<th field="url" sortable="true" align="center" width="13%">图片链接</th>
			<th field="remark" sortable="true" align="center" width="13%">备注文字</th>
			<th field="contentname" sortable="true" align="center" width="13%">文字</th>
			<th field="content" sortable="true" align="center" width="13%">文字链接</th>
...
<div id="toolbar">
	<div class="express-search">
		<form id="searchForm" name="searchForm">
			<express:SelectTag id="sectioncode" type="select" dictGroupCode="COMMUNITY_COL" defaultOption="栏目分块类型" cssClass="easyui-combobox"/>
			&nbsp;&nbsp;
	...
	<div style="">
		<a href="javascript:add($('#grid'),$('#win'),'<%=basePath%>im/community/editView.do?columnid=${columnid}','<%=basePath%>im/community/add.do',{'title':'新增'});" class="easyui-linkbutton" iconCls="icon-add">增加</a>
		<a href="javascript:modify($('#grid'),$('#win'),'<%=basePath%>im/community/editView.do','<%=basePath%>im/community/edit.do',{'title':'修改'})" class="easyui-linkbutton" iconCls="icon-edit">修改</a>
		<a href="javascript:del($('#grid'),'<%=basePath%>im/community/delete.do')" class="easyui-linkbutton" iconCls="icon-remove">删除</a>
	</div>
</div>
<div id="win">
...
$(function(){
	$('#grid').datagrid({
		method: 'post',
        url: '<%=basePath%>im/community/homelist.do?columnid=${columnid}',
        width:'auto',
        height:'auto',
        rownumbers: true,
        fit: true,
