	...
	<div class="panel panel-primary" style="margin-top:20px;">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="contentid" id="contentid" value="${object.contentid}"/>
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:10px;">备注文字:</label>
					<div class="col-xs-9">
						<input id="remark" name="remark" type="text" value="${object.remark}" class="form-control"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:10px;">文字:</label>
					<div class="col-xs-9">
						<input id="contentname" name="contentname" type="text" value="${object.contentname}" class="form-control"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:10px;">文字链接:</label>
					<div class="col-xs-9">
				...
				<div class="form-group">
					...
					<div class="col-xs-9" style="padding-top:10px;">
						<express:SelectTag id="sectioncode" name="sectioncode" type="select" selected="${object.sectioncode}" dictGroupCode="COMMUNITY_COL" defaultOption="所属栏目分块" cssClass="form-control"/>
					</div>
				</div>
				<div class="form-group">
