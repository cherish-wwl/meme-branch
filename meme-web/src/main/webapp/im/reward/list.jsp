...
<table id="grid" toolbar="#toolbar">
	<thead>
		<tr>
			...
			<th field="account1" sortable="true" align="center" width="10%">被赏会员账号</th>
			<th field="nickname1" sortable="true" align="center" width="10%">被赏会员昵称</th>
			<th field="mtypeText1" sortable="true" align="center" width="10%">被赏会员类型</th>
			...
			<th field="account2" sortable="true" align="center" width="10%">打赏会员账号</th>
			<th field="nickname2" sortable="true" align="center" width="10%">打赏会员昵称</th>
			<th field="mtypeText2" sortable="true" align="center" width="10%">打赏会员类型</th>
			<th field="money" sortable="true" align="center" width="10%">打赏金额</th>
...
<div id="toolbar">
	<div class="express-search">
		<form id="searchForm" name="searchForm">
			被赏会员昵称或账号：<input class="easyui-textbox" type="text" id="member_str1" name="member_str1"/>&nbsp;&nbsp;
			打赏会员昵称或账号：<input class="easyui-textbox" type="text" id="member_str2" name="member_str2"/>&nbsp;&nbsp;
			...
			&nbsp;&nbsp;
			打赏时间：<input class="easyui-datetimebox" type="text" id="startdate" name="startdate"/>至
...
$(function(){
	$('#grid').datagrid({
		method: 'post',
        url: '<%=basePath%>im/reward/list.do',
        width:'auto',
        height:'auto',
        rownumbers: true,
        fit: true,
