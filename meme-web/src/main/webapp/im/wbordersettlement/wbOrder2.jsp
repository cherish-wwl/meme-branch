...
<table id="grid" toolbar="#toolbar">
	<thead>
		<tr>
			...
			<th field="amount" sortable="true" align="center" width="20%">订单金额</th>
			<th field="nickname" sortable="true" align="center" width="20%">会员昵称</th>
			<th field="account" sortable="true" align="center" width="20%">会员账号</th>
			<th field="settlement_time" sortable="true" align="center" width="20%">结算日期</th>
		</tr>
	</thead>
</table>
<div id="win">
