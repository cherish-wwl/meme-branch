...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		imageSizeLimit = K.undef(self.imageSizeLimit, document.getElementById('sizeLimit').value),
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png'),
		imageUploadLimit = K.undef(self.imageUploadLimit, document.getElementById('uploadLimit').value),
		filePostName = K.undef(self.filePostName, 'imgFile'),
		lang = self.lang(name + '.');
