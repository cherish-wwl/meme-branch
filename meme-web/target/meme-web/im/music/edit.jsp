	...
	<div class="panel panel-primary" style="margin-top:20px;">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="contentid" id="contentid" value="${object.contentid}"/>
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" style="padding-top:10px;">音乐名称:</label>
					<div class="col-xs-9">
				...
				<div class="form-group">
					...
					<div class="col-xs-9" style="padding-top:10px;">
						<express:SelectTag id="sectioncode" name="sectioncode" type="select" selected="${object.sectioncode}" dictGroupCode="AUDIO_COL" defaultOption="所属栏目分块" cssClass="form-control"/>
					</div>
				</div>
				<div class="form-group">
