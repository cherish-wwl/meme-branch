...
<div class="container-fluid">
	...
	<div class="panel panel-primary" style="margin-top:20px;">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="part" id="part" value="${object.part}"/>
			<input type="hidden" name="memberid" id="memberid" value="${object.memberid}"/>
				...
				<div class="form-group">
					...
					<div class="col-xs-9">
						<express:SelectTag id="type" name="type" type="select" selected="${object.type}" dictGroupCode="HOMEPAGE_TYPE" defaultOption="请选择" cssClass="form-control"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div style="text-align: left"><label>图文内容:</label></div>
					<%
					MemeHomePage obj=(MemeHomePage)request.getAttribute("object");
