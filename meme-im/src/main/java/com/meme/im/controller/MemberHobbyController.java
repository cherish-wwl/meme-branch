...
@Controller
@RequestMapping("/manage/memberHobby/")
public class MemberHobbyController extends BaseController {
	...
	public Pagination list(@RequestParam(defaultValue = "1") Integer pageNo, 
					@RequestParam(defaultValue = "20") Integer pageSize, MemberHobby record) {
		
		PageInfo<MemberHobby> page = this.memberHobbyService.selectByEntity(record, pageNo, pageSize);
